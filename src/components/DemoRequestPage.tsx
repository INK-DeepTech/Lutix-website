    ...
    <div className="flex flex-col w-full bg-corp-light text-corp-navy min-h-screen">
      ...
      <section className="w-full bg-[#f2f3ff] py-12 md:py-16 px-6 md:px-8 border-b border-[#e2e7ff] relative overflow-hidden">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center gap-4 relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-corp-navy tracking-tight font-serif-brand">
        ...
        <div className="bg-corp-light p-8 sm:p-12 rounded-3xl border border-[#dae2fd] shadow-xl">
          <form onSubmit={handleSubmit} noValidate className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-corp-deep/40 transition-all ${
                      formErrors.name ? 'border-[#ba1a1a] bg-[#ffdad6]/10' : 'border-[#e2e7ff] bg-corp-light hover:border-[#dae2fd]'
                    }`}
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-corp-deep/40 transition-all ${
                      formErrors.email ? 'border-[#ba1a1a] bg-[#ffdad6]/10' : 'border-[#e2e7ff] bg-corp-light hover:border-[#dae2fd]'
                    }`}
                  />
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-corp-deep/40 transition-all ${
                      formErrors.org ? 'border-[#ba1a1a] bg-[#ffdad6]/10' : 'border-[#e2e7ff] bg-corp-light hover:border-[#dae2fd]'
                    }`}
                  />
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-[#e2e7ff] bg-corp-light hover:border-[#dae2fd] text-sm focus:outline-none focus:ring-2 focus:ring-corp-deep/40 transition-all resize-none"
                />
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-[#eaedff]">
              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-corp-deep text-white font-bold text-sm hover:bg-corp-vibrant transition-all shadow-md flex items-center justify-center gap-2 group"
              >
      ...
      {isSubmitted && (
        ...
        >
          <div className="bg-corp-light rounded-3xl max-w-sm w-full p-8 shadow-2xl border border-[#dae2fd] text-center space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-bold text-corp-navy font-serif-brand">
                Message Received
              </h3>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-corp-deep text-white font-semibold text-sm hover:bg-corp-vibrant transition-all"
            >
              Close
            </button>
          </div>

    ...
    <div className="flex flex-col w-full bg-brand-mint text-brand-navy min-h-screen">
      ...
      <section className="w-full bg-[#f2f3ff] py-12 md:py-16 px-6 md:px-8 border-b border-[#e2e7ff] relative overflow-hidden">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center gap-4 relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brand-navy tracking-tight font-serif-brand">
            Let's discuss your ecosystem.
          </h1>
          <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mt-2">
      ...
      <section className="w-full py-12 md:py-16 px-6 md:px-8 max-w-3xl mx-auto -mt-12 relative z-20">
        <div className="bg-brand-mint p-8 sm:p-12 rounded-3xl border border-[#dae2fd] shadow-xl">
          <form onSubmit={handleSubmit} noValidate className="space-y-8">
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label htmlFor="fullName" className="text-xs font-bold uppercase tracking-wider text-slate-600 block mb-2">
                  Full Name
                </label>
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/40 transition-all ${
                      formErrors.name ? 'border-[#ba1a1a] bg-[#ffdad6]/10' : 'border-[#e2e7ff] bg-brand-mint hover:border-[#dae2fd]'
                    }`}
                  />
              ...
              <div>
                <label htmlFor="workEmail" className="text-xs font-bold uppercase tracking-wider text-slate-600 block mb-2">
                  Work Email
                </label>
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/40 transition-all ${
                      formErrors.email ? 'border-[#ba1a1a] bg-[#ffdad6]/10' : 'border-[#e2e7ff] bg-brand-mint hover:border-[#dae2fd]'
                    }`}
                  />
              ...
              <div className="sm:col-span-2">
                <label htmlFor="organization" className="text-xs font-bold uppercase tracking-wider text-slate-600 block mb-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/40 transition-all ${
                      formErrors.org ? 'border-[#ba1a1a] bg-[#ffdad6]/10' : 'border-[#e2e7ff] bg-brand-mint hover:border-[#dae2fd]'
                    }`}
                  />
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-[#e2e7ff] bg-brand-mint hover:border-[#dae2fd] text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/40 transition-all resize-none"
                />
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-[#eaedff]">
              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-brand-teal text-white font-bold text-sm hover:bg-brand-cyan transition-all shadow-md flex items-center justify-center gap-2 group"
              >
        ...
        <div className="mt-8 text-center text-xs text-[#777587]">
          Prefer direct email? Contact us at <a href="mailto:enterprise@lutix.internal" className="text-brand-teal font-semibold hover:underline">enterprise@lutix.internal</a>
        </div>
      </section>
      ...
      {isSubmitted && (
        ...
        >
          <div className="bg-brand-mint rounded-3xl max-w-sm w-full p-8 shadow-2xl border border-[#dae2fd] text-center space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-bold text-brand-navy font-serif-brand">
                Message Received
              </h3>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-brand-teal text-white font-semibold text-sm hover:bg-brand-cyan transition-all"
            >
              Close
            </button>
          </div>

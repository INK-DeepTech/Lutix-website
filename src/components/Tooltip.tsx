    ...
    <span className="relative inline-block">
      ...
      {visible && (
        <span
          ...
          id="tooltip-popup"
          role="tooltip"
          className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 rounded-lg bg-corp-light text-corp-navy text-[11px] border border-slate-200 leading-relaxed font-normal whitespace-nowrap shadow-lg z-50 pointer-events-none animate-in fade-in duration-150"
        >
          {label}

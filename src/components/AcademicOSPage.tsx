        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-corp-deep rounded-3xl p-10 md:p-16 text-white relative overflow-hidden shadow-xl">
            ...
            <div className="max-w-3xl flex flex-col gap-6 relative z-10">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-corp-light/20 text-white font-medium text-xs w-fit">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-6">
                <button 
                  ...
                  className="bg-corp-light text-corp-vibrant px-8 py-4 rounded-xl font-semibold text-sm hover:bg-slate-100 transition-all shadow-md flex items-center gap-2"
                >
